...
def reward_adapter(env_obs):
    ...
    lane = 0.001 if env_obs.ego_vehicle_state.lane_index == 0 else 0
    # print(env_obs.ego_vehicle_state.lane_index)
    return 0.01 * progress + goal + crash + lane
...
class EXIT_Trainer:
    def __init__(
        ...
        if isinstance(args, dict):
            _args = args
            args = policy.__class__.get_argument(EXIT_Trainer.get_argument())
